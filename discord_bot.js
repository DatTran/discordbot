...
var commands = {
 ...
 //       	    }
    ...
    "channel" : {
        usage: "",
        description: "FLASHMOB is on Balenos E2",
        process: function(bot,msg,suffix) {
            var message = 'The guild uses Balenos E2';
            bot.sendMessage(msg.channel, message);
        }
    },
    "website" : {
        usage: "",
        description: "Returns guild website",
        process: function(bot,msg,suffix) {
            var message = 'http://flashmobguild.com/';
            bot.sendMessage(msg.channel, message);
        }
    },
    "server" : {
        usage: "",
        description: "Returns guild channel we use",
        process: function(bot,msg,suffix) {
            var message = 'FLASHMOB is on the Eden server';
            bot.sendMessage(msg.channel, message);
        }
    },
    "highfive" : {
    ...
    "about" : {
        usage: "",
        description: "Returns guid description",
        process: function(bot,msg,suffix) {
            var desc = 'We are in search of like-minded individuals whose realistic goals include but are not limited to: GvG, Siege, PKK Justice, Arenas, Commerce, Crafting & Gathering. Okay, so basically we strive to be present in all areas of the game. Yes, every guild stakes a claim in superiority. However, the difference between us and a lot of other guilds is our collective mindset. We know who we are as a guild. FLASHMOB is NOT a multigaming community that will inevitably move on to the next big thing. We are a guild created solely for the purposes of BDO. We intend to stay and grow with BDO. We are a guild of real people. By real, I mean in the sense that we do not believe in the anonymity of the internet. We do not hide from one another the person behind the character. Our goal is to be a guild you call home; made up of determined individuals who know what, when, where and how to get the job done. Granted, knowledge will come with time as BDO is a lengthy learning process for most players. Let\'s learn and grow together. We have jobs, spouses, families etc. and we don\'t expect our members to risk losing/sacrifice those parts of their lives to play BDO (my wife plays with me, but I need to spend more time with her out of game, otherwise she will kill me.. and nobody wants that :P). This doesn\'t mean we are any less serious than a guild of players with no lives. This means we will be making efficient use of our time. FLASHMOB will be rolling on the Edan server.';
            bot.sendMessage(msg.channel, 'Hi '+msg.author);
            bot.sendMessage(msg.channel, desc);
        }
    },
    "uptime": {
    	usage: "",
